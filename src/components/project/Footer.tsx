...
function Footer() {
  ...
  return (
    <footer className="border-t border-gray-200 bg-primary-blue text-white">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <nav className="flex space-x-6">
              <Link href="/" className="hover:text-primary-light-blue-200 transition-colors">Home</Link>
              <Link href="https://www.hemanthbabu648.com/about-me" className="hover:text-primary-light-blue-200 transition-colors">About Us</Link>
              <Link href="https://www.hemanthbabu648.com/#contact" className="hover:text-primary-light-blue-200 transition-colors">Contact</Link>
            </nav>
            {/* Copyright */}
            <div className="text-center text-sm text-primary-light-blue-200 mt-6">
              &copy; {new Date().getFullYear()} Hemanth Babu Setti. All rights reserved.
            </div>
            <div className="flex items-center space-x-6">
              <div className="flex space-x-4">
                <a href="https://www.linkedin.com/in/hemanthbabu648" className="hover:text-primary-light-blue-200 transition-colors">
                  <FaLinkedin size={24} />
                </a>
                <a href="https://twitter.com/hemanthbabu648" className="hover:text-primary-light-blue-200 transition-colors">
                  <FaTwitter size={24} />
                </a>
                <a href="https://t.me/hemanthbabu648" className="hover:text-primary-light-blue-200 transition-colors">
