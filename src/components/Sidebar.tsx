...
import { BRAND_LOGO, BRAND_NAME, HOME_SITE_URL } from '@/constants/home';
  ...
  return (
    <nav className={clsx('w-full flex-none bg-primary-dark text-white')}>
      <div className="h-screen flex flex-col justify-between border-r border-primary-light-blue-200">
        {/* Brand */}
        <Link href={HOME_SITE_URL} className="flex items-center gap-3 p-2 h-20 border-b border-primary-light-blue-200">
